...
| WeBASE 版本  | CDN 地址  |
|---|---|
| v1.4.0  |  `https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/WeBASE/releases/download/{release_version}/webase-{subsystem}.zip` |
| v1.3.2 及以前版本  |  `https://www.fisco.com.cn/cdn/webase/releases/download/{release_version}/webase-{subsystem}.zip` |
