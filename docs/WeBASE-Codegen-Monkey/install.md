...
##### 1.2.3.2 选择二：本机编译，复制执行包到其他服务器上运行
...
##### 1.2.3.3 选择三：本机编译，复制执行包到其他服务器，使用supervisor来启动。
...
恭喜您，到以上步骤，您已经完成了数据导出组件的安装和部署。如果您还需要额外获得可视化的监控页面，请参考1.3
