...
* 如果本地没有镜像（如果本地有镜像，跳过）
    ...
    * 从 CDN 拉取镜像压缩包
    ...
    # 从 CDN 拉取镜像 tar 文件
    # 非国密
    wget https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/WeBASE/download/docker/image/v2.6.0/docker-fisco-webase.tar
    # 国密
    wget https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/WeBASE/download/docker/image/v2.6.0/docker-fisco-webase-gm.tar
